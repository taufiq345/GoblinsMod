...
public class NearestAttackEntity<T extends LivingEntity> extends TargetGoal {
   protected final Class<T> targetClass;
   protected final int targetChance;
   protected LivingEntity nearestTarget;
   /** This filter is applied to the Entity search. Only matching entities will be targeted. */
   protected EntityPredicate targetEntitySelector;
   private final boolean attackanim;

   public NearestAttackEntity(MobEntity goalOwnerIn, Class<T> targetClassIn, boolean checkSight,boolean attackanim) {
      this(goalOwnerIn, targetClassIn, checkSight, false,false);
   }

   public NearestAttackEntity(MobEntity goalOwnerIn, Class<T> targetClassIn, boolean checkSight,boolean attackanim, boolean nearbyOnlyIn) {
      this(goalOwnerIn, targetClassIn, 10, checkSight,attackanim,nearbyOnlyIn, (Predicate<LivingEntity>)null);
   }

   public NearestAttackEntity(MobEntity goalOwnerIn, Class<T> targetClassIn, int targetChanceIn, boolean checkSight,boolean attackanim, boolean nearbyOnlyIn, @Nullable Predicate<LivingEntity> targetPredicate) {
