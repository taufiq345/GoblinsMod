package com.goblinsmod.Gobmain.common.items;
...
public class ModSpawnEggItems extends SpawnEggItem {
    ...
    public ModSpawnEggItems(final RegistryObject<? extends EntityType<?>> entityTypeSupplier, final int primaryColour, final int secondaryColour, final Item.Properties properties) {
